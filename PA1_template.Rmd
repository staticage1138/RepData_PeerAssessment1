...
We find that the mean total number of steps per day is `r activity.mean$mean.steps` and the median is `r activity.mean$median.steps`.
...
We can see that the mean value changed by `r activity.imputed.mn$mean.diff` and the median changed by `r activity.imputed.mn$median.diff` due to the imputation process.
